...
/*!
 * @class RS40XCB_ARMComp
 * @brief Standalone component Class
 *
 */
public class RS40XCB_ARMComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(RS40XCB_ARM.component_conf);
      mgr.registerFactory(prop, new RS40XCB_ARM(), new RS40XCB_ARM());

      // Create a component
      RTObject_impl comp = mgr.createComponent("RS40XCB_ARM");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        RS40XCB_ARMComp init = new RS40XCB_ARMComp();
